...
export const Home = () => {
  return (
    <div id="home_style" style={{marginTop:"-45px"}}>
      {/* <Navbar /> */}
      <div id="banner1">
        <h2>iPhone 14 Pro</h2>
        <h3>Pro. Beyond</h3>
      ...
      <div id="banner4">
        ...
        <div className="banner4_sub1">
          ...
          <h5>
            Apple Worldwide Developers Conference. <br /> Join us online from 5
            to 9 June.{" "}
          </h5>
          <div className="banner_links">
            <a href="" style={{ color: "white" }}>
        ...
        <div className="banner4_sub4">
          <h4>
            Take Your Picks of <br /> Mother's Day gifts.{" "}
          </h4>
          <h5>
            So many ways to thank <br /> whoever you call Mom{" "}
          </h5>
          <div className="banner_links">
            <a href="" style={{ color: "white" }}>
              Shop the gift guide
